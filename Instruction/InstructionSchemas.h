...
#include "../Operator/OperatorEnums.h"   //Mnemonic, Prefix, Group
#include "../Operator/OperatorSchemas.h" //OperatorSchema

#include "../Operand/OperandEnums.h"     //AddressingMethod, GeneralRegister, SegmentRegister, Constant
#include "../Operand/OperandSchemas.h"   //OperandSchema
